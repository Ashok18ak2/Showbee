...
const SeatLayout = () => {
  ...
  const bookTickets = async()=>{
    try {
      ...
      if(!selectedTime || !selectedSeats.length) toast.error('please select time and seats')
  ...
  return show? (
    <div className='flex flex-col md:flex-row items-start gap-12 px-6 md:px-16 lg:px-24 pt-32 pb-20 min-h-screen'>
      {/*Available Timings */}
      ...
      {/*Seats Layout*/}
      <div className='relative flex-1 flex flex-col items-center mt-6 md:mt-0'>
